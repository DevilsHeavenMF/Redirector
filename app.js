...
function setupForkButton() {
    if (unr == "AnonymousR1025") {
        document.getElementById("fork").innerHTML = `<a class="github-button" href="https://github.com/AnonymousR1025" data-color-scheme="no-preference: dark_dimmed; light: dark_dimmed; dark: dark_dimmed;" data-size='large' aria-label="AnonymousR1025">AnonymousR1025</a>`;
    } else {
